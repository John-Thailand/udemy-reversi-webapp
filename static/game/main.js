...
const showNextDiscMessageElement = document.getElementById('next-disc-message')
...
function showNextDiscMessage(nextDisc) {
    if (nextDisc) {
        ...
        showNextDiscMessageElement.innerText = `次は${discToString(nextDisc)}の番です`
    } else {
        showNextDiscMessageElement.innerText = ''
    }
}
